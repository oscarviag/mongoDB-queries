...
db.restaurants.find( {$or: [ {name: /^Wil/}, { $and: [ {"cuisine" : {$ne :"American "}}, {"cuisine" : {$ne :"Chinese"}} ] } ] }, {"restaurant_id" : 1,"name":1,"borough":1,"cuisine" :1, "_id":0} ); db.restaurants.find( {$or: [ {name: /^Wil/}, "cuisine" : "Seafood"]}, {"restaurant_id" : 1,"name":1,"borough":1,"cuisine" :1, "_id":0} );
